...
public class JsonCreator {
    ...
    private JsonCreator(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    public static JsonCreator defaultInstance() {
        return new JsonCreator(new ObjectMapper());
    }
    ...
    public static class JsonConstructorBuilder {
        ...
        public JsonCreator build() {
            return new JsonCreator(this.objectMapper);
        }
    }
}
/**
