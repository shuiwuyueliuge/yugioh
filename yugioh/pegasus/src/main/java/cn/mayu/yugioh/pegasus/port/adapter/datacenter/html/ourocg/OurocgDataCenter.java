...
public class OurocgDataCenter implements DataCenter {
    ...
    private HtmlHandler<List<CardInfo>> cardInfoHtmlHandler;

    public OurocgDataCenter(String domain, String description, boolean exists) {
        this.domain = domain;
    ...
    @Override
    public List<MetaData> obtainMetaData(Collection<String> resources, String dataType) {
        return null;
    }
     ...
     */
    @Override
    public Optional<List<CardInfo>> obtainCardList() {
        List<CardInfo> result = Lists.newArrayList();
        int page = 1;
        while(true) {
