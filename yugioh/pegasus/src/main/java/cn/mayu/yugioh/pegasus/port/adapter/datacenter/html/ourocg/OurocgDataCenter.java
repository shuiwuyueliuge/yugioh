...
public class OurocgDataCenter extends AbstractDataCenter {
    ...
    private HtmlHandler<List<CardDTO>> cardInfoHtmlHandler;
    ...
    @Override
    public Iterator obtainCards() {
        return null;
    }

    public static class OurocgDataCenterIterator implements Iterator {
     ...
     */
//    @Override
//    public List<CardDTO> obtainCards() {
//        int start = 888;
//        List<CardDTO> cardDTOList = Lists.newArrayList();
//        while (true) {
//            List<CardDTO> infos = cardInfoHtmlHandler.handle("https://www.ourocg.cn/card/list-5/" + start);
//            cardDTOList.addAll(infos);
//            if (infos.size() < 10) {
//                break;
//            }
//
