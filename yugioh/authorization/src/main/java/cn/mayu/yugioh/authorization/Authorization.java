package cn.mayu.yugioh.authorization;
...
public class Authorization {
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(Authorization.class);
    ...
    @Bean
    public Consumer<ExpressionUrlAuthorizationConfigurer<HttpSecurity>.ExpressionInterceptUrlRegistry> jwks() {
        return registry -> registry.antMatchers("/.well-known/jwks.json").permitAll();
    }
}
 ...
 * -Dskywalking.agent.service_name=authorization
 */
